...
Applied minimal changes to enable realtime readiness for CTS v1.

Files added/modified:
- config/flags.json: centralized feature flags defaults
- src/config/featureFlags.ts: reads ENV then flags.json, logs missing keys
- .agent/agents/agent-task-runner.ps1: backups-first, Resolve-Mode, hard-gate helper
- .agent/agents/agent-reporting.ps1: write run-latest and history, shadow compare stub
- .agent/scripts/agent-health-check.ps1: health probe script
- .agent/scripts/telegram-send.ps1: telegram stub with dedupe and dead-letter
- .agent/reports/, .agent/logs/ created as needed
- .github/pull_request_template.md, .github/workflows/ci-quick-checks.yml
- templates/strategy-sample.json, migration/README-migrate-feature-flags.md

How to revert: undo commits or remove files listed above.
