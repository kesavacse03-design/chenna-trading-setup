...
# Migrate feature flags to config/flags.json

1. Add new flag to config/flags.json
2. Update src/config/featureFlags.ts if new keys added
3. Replace direct process.env or inline constants with imports from featureFlags
