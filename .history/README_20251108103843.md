...
Optional Future Items:
    - Smart Mode toggle (adaptive tuning pass) — sets `refine=true&searchMode=hybrid`.
    - Temperature sensor integration (requires backend endpoint).
    - Notification hooks (Telegram) reading promotion summary.
