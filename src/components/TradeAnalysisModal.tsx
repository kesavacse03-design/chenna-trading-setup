        ...
        return (
            <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                ...
                <div className="grid grid-cols-3 gap-3 text-center mb-3">
                    <div><p className="text-xs text-slate-400">Entry</p><p className="font-mono font-semibold">₹{setup.entry.toFixed(2)}</p></div>
                    <div><p className="text-xs text-green-400">Target</p><p className="font-mono font-semibold text-green-300">₹{setup.target.toFixed(2)}</p></div>
                    <div><p className="text-xs text-red-400">Stop Loss</p><p className="font-mono font-semibold text-red-300">₹{setup.stopLoss.toFixed(2)}</p></div>
                </div>
                <div>
